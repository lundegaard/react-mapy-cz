...
declare namespace JAK {
	class Signals {
		addListener(
			owner?: object,
			type: string,
			handleFunction: (e: BaseSyntheticEvent) => void,
			sender?: object
		): void;
...
declare namespace SMap {
     ...
     */
		 ...
		 * @returns {SMap.Marker}
		 */
		decorate(marker: any, card: SMap.Card): SMap.Marker;
	}
	 ...
	 */
	class Geometry implements SMap.Layer {
		/**
     ...
     */
		getResults(): { altitude: []; geometry: Smap.Coords[]; itinerary: [] };
	...
	namespace Control {
       ...
       */
		...
		class Zoom {
			 ...
			 * @param {object} [options] Konfigurační objekt.
			 */
			constructor(labels: { [key: number]: string }, options?: object);
